// The call chain from getMessage to the messaging service (D1). Copied from
// encrypt/src/chain.ts. The caller presented a person token for decrypt;
// decrypt asks the PS that
