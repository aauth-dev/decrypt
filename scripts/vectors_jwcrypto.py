# Interop vector from jwcrypto (Python): the same compact JWE from a second
...
plaintext = json.dumps({'text': 'Hello from jwcrypto. Sphinx of black quartz, judge my vow.'}, separators=(',', ':'))
